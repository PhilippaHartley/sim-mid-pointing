...
if __name__ == '__main__':
    ...
    block_vis = create_blockvisibility_from_ms('PE_0.0_arcsec.ms')[0]
    block_vis.configuration.location = EarthLocation(lon="21.443803", lat="-30.712925", height=0.0)
    block_vis.configuration.frame = ''
    print(block_vis)
